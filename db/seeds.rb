...
questions=[
{:question => 'Where is your favorite place to study?', :total => 0},
...
{:question => 'How many hours do you spend in the library each month?', :total => 0},
...
{:Question_id => 3, :answers => '0'},
{:Question_id => 3, :answers => '1'},
{:Question_id => 3, :answers => '2'},
{:Question_id => 3, :answers => '3'},
{:Question_id => 3, :answers => '4 or more'},
{:Question_id => 4, :answers => 'Rose'},
{:Question_id => 4, :answers => 'Lotus'},
{:Question_id => 4, :answers => 'Other'},
{:Question_id => 5, :answers => 'Computer Science'},
{:Question_id => 5, :answers => 'Software Engineering'},
{:Question_id => 5, :answers => 'Electrical Engineering'},
{:Question_id => 5, :answers => 'Other'},
{:Question_id => 6, :answers => 'Tennis'},
{:Question_id => 6, :answers => 'Baseball'},
{:Question_id => 6, :answers => 'Football'},
{:Question_id => 6, :answers => 'Basketball'},
{:Question_id => 6, :answers => 'Other'},
{:Question_id => 7, :answers => '0-5'},
{:Question_id => 7, :answers => '6-10'},
{:Question_id => 7, :answers => '11-15'},
{:Question_id => 7, :answers => '16-20'},
{:Question_id => 7, :answers => '20 or more'},
