...
{:first_name => 'Mona', :last_name => "Garvin", :email => "mona-garvin@uiowa.edu
",:phone => "(319) 335-5950", :education=>"Ph.D., Biomedical Engineering, The University of Iowa, 2008
...
{:first_name => 'Hassan', :last_name => "Raza", :email => "hassan-raza@uiowa.edu",
:phone => "(319) 384-1879", :education=>"Ph.D., Electrical and Computer Engineering, Purdue University, 2007.
...
:image_path=>"http://www.engineering.uiowa.edu/sites/default/files/styles/profile_portrait/public/field/image/Raza%2C%20Hassan.jpg?itok=yOVMh16s"},
...
{:first_name => 'David', :last_name => "Andersen", :email => "k0rx@uiowa.edu",
